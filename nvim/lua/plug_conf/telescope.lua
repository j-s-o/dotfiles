...
vim.keymap.set(mode.normal, "<leader>fc", ":Telescope command_history<CR>", { noremap = true })
vim.keymap.set(mode.normal, "<leader>fh", ":Telescope find_files hidden=true no_ignore=true hidden=true<CR>", { noremap = true })
vim.keymap.set(mode.normal, "<leader>fg", ":Telescope live_grep<CR>", { noremap = true })
vim.keymap.set(mode.normal, "gs", ":Telescope grep_string<CR>", { noremap = true })
vim.keymap.set(mode.normal, "<leader>fb", ":Telescope buffers<CR>", { noremap = true })
vim.keymap.set(mode.normal, "<leader>fk", ":Telescope keymaps<CR>", { noremap = true })
